...
$(document).ready(function () {
  ...
  var $INQURY_BOX = $(".crm_inquiry_form_boxcustom_inquiry_form_1760403310954581");
...
$(document).ready(function () {
  ...
  var $INQURY_BOX = $(".crm_inquiry_form_boxcustom_inquiry_form_1760403555365943");
  var crmEmailStr = "Please enter a valid email address";
  var pagetitle = '';
  $('#pagetitle').val(document.title);
...
;
$(function () {
  var swiper = new Swiper(".insucom-what-our-block .test-two-swiper-wrapper", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 2000,
    autoplay: {
...
$(document).ready(function () {
  ...
  var $INQURY_BOX = $(".crm_inquiry_form_boxcustom_inquiry_form_1767162044577484");
  var crmEmailStr = "Please enter a valid email address";
  var pagetitle = '';
  $('#pagetitle').val(document.title);
